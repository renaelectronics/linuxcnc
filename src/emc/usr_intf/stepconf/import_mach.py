...
sc.write('  <property name="amotorcurrent" type="int" value="1"/>\n')
...
sc.write('  <property name="xmotorcurrent" type="float" value="1.0"/>\n')
...
sc.write('  <property name="ymotorcurrent" type="float" value="1.0"/>\n')
...
sc.write('  <property name="zmotorcurrent" type="float" value="1.0"/>\n')
